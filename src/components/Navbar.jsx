    ...
    >
      ...
      {mobileMenuOpen && (
        ...
        >
          ...
          {currentUser && (
            <button
              onClick={() => handleNavClick('absence-chamber')}
              style={{
                padding: '0.65rem 0.8rem',
                background: activeView === 'absence-chamber' ? 'rgba(197, 159, 78, 0.25)' : 'rgba(197, 159, 78, 0.08)',
                border: activeView === 'absence-chamber' ? '1px solid var(--gold-ancient)' : '1px solid rgba(197, 159, 78, 0.2)',
                borderRadius: '4px',
                color: '#f7dca0',
                textAlign: 'left',
                fontFamily: 'var(--font-heading)',
